...
var Chat = function () {
	...
	_createClass(Chat, [{
		key: 'recieveMessage',
		value: function recieveMessage(callback) {
			var _this = this;
...
var _chatwindow = __webpack_require__(52);
...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.setNickname = _this.setNickname.bind(_this);
	...
	_createClass(App, [{
		...
		value: function render() {
			if (this.state.nickname.trim() == '') {
				return _react2.default.createElement(_login2.default, { setNickname: this.setNickname });
			} else {
				return _react2.default.createElement(_chatwindow2.default, { nickname: this.state.nickname });
			}
		}
	}]);
...
*/
var aa=__webpack_require__(6),l=__webpack_require__(18),B=__webpack_require__(7),C=__webpack_require__(3),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(8);
...
var _chatwindow = __webpack_require__(24);
...
var ChatWindow = function (_React$Component) {
	...
	function ChatWindow(props) {
		...
		chat.recieveMessage(function (messages) {
	...
	_createClass(ChatWindow, [{
		key: 'sendMessage',
		value: function sendMessage(message_text) {
			var message = { text: message_text, user: this.props.nickname };
		...
		value: function render() {
			return React.createElement(
				'div',
				{ className: _chatwindow2.default.chat_window },
				React.createElement(ChatBox, { messages: this.state.messages }),
				React.createElement(MessageInput, { messageHandler: this.sendMessage })
			);
		}
	}]);
...
var MessageInput = function (_React$Component3) {
	...
	_createClass(MessageInput, [{
		...
		value: function render() {
			return React.createElement(
				'form',
				{ onSubmit: this.handleSubmit, className: _chatwindow2.default.message_input },
				React.createElement('input', { value: this.state.message, onChange: this.handleChange,
	...
	_createClass(Message, [{
		...
		value: function showNewMessage() {
			if (this.props.new) {
				return React.createElement(
					'li',
					{ className: _chatwindow2.default.new_message },
					React.createElement(
						'span',
						null,
						this.props.user,
				...
				return React.createElement(
					'li',
					{ className: _chatwindow2.default.user_message },
					React.createElement(
						'span',
						null,
						this.props.user,
...
// exports
exports.locals = {
	"chat_window": "_1yXTuFme8Dl0XmgHXPKMVe",
...
var Login = function (_React$Component) {
	...
	_createClass(Login, [{
		...
		value: function render() {
			return React.createElement(
				'form',
				{ onSubmit: this.handleSubmit, className: _login2.default.login },
				React.createElement('input', { type: 'text', value: this.state.value, placeholder: 'YOUR NICKNAME',
...
// module
exports.push([module.i, "._17LssDw0QsjdfilQIWkyJE{\n\tbackground-color: #9932cc;\n\twidth: 60%;\n\theight: 40%;\n\ttext-align: center;\n}\n\n._17LssDw0QsjdfilQIWkyJE, ._17LssDw0QsjdfilQIWkyJE input{\n\ttext-align: center;\n\tposition: absolute;\n\tleft: 50%;\n\ttop: 50%;\n\tborder-radius: 2%;\n\ttransform: translate(-50%, -50%);\n}\n\n._17LssDw0QsjdfilQIWkyJE input{\n\tborder: none;\n\tpadding: 4%;\n\twidth: 70%;\n\tbackground-color: #fde\n}", ""]);

// exports
exports.locals = {
	"login": "_17LssDw0QsjdfilQIWkyJE"
};
